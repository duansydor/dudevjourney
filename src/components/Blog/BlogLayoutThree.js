...
function BlogLayoutThree({blog}) {
  return (
    <article className='flex flex-col group'>
      ...
      <div className="mt-4">
        <span className='uppercase text-accent dark:text-accentDark font-bold'>{`${blog.tags[0]}`}</span>
        <Link href={blog.url} className="mt-6">
          <h1 className="font-bold capitalize text-lg dark:text-light">
            <span
        ...
        <span className="capitalize text-dark/50 font-semibold text-base dark:text-light/40">
